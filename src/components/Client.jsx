      ...
      <div className="container">
        <div className="container mt-4">
          <div className="container text-center">
            <h4 className="text-2xl lg:text-3xl text-[#4D4D4D] mt-4">Our Clients</h4>
            <p className="text-[#717171] mt-3">We have been working with some Fortune 500+ clients</p>
          </div>
          <div className="flex flex-wrap justify-center lg:gap-28 gap-8 mt-5 cursor-pointer">
          ...
          <div className="text-center mt-7">
            <h4 className="text-xl lg:text-2xl mt-8 text-[#4D4D4D]">
          ...
          <div className="flex flex-wrap justify-center mt-10 gap-4">
            {community.map((communities) => (
              <div key={communities.src} className="text-center max-w-xs p-4">
                <Image
                  src={communities.src}
